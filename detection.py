...
class Detecter(Core2.Core):
    ...
    def network(self):
        ...
        self.y51 = SE_module(x = self.y50,
                             InputNode = [self.SIZE / 64, self.SIZE / 64, StemChannels + 12 +GrowthRate * 24],
                             Act = Activation,
                             Rate = 0.5,
                             vname = 'TOP_SE')
        ...
        # reshape
        self.y71 = Layers.reshape_tensor(x = self.y61, shape = [StemChannels + 12 +GrowthRate * 24])
        ...
        self.y72 = Outputs.output(x = self.y71_d,
                                  InputSize = StemChannels + 12 + GrowthRate * 24,
                                  OutputSize = 15,
                                  Initializer = 'Xavier',
