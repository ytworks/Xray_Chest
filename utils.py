...
def config_list(args):
    ...
    nih_data_path = config.get('Data', 'nih_images')
    return size, augment, checkpoint, lr, dlr, rtype, rr, l1_norm, dumping_rate, dumping_period, epoch, batch, log, tflog, ds, roi, output_type, outfile, mode, step, split_mode, network_mode, auc_file, validation_set, optimizer_type, nih_data_path
