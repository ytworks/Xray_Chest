...
def conv_block(x,
    ...
    x1e = Layers.dilated_convolution2d(x = x_act3,
    ...
    x1f = Layers.separable_convolution2d(x = x_act3,
    ...
    x1g = Layers.separable_convolution2d(x = x_act3,
                                         FilterSize = [5, 5, GrowthRate, GrowthRate/4],
                                         Initializer = Initializer,
                                         ChannelMultiplier = 2,
                                         Rate = (1,1),
    ...
    x1h = Layers.separable_convolution2d(x = x_act3,
