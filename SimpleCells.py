...
def conv_block(x,
    ...
    x1a = Layers.convolution2d(x = x_act2,
                               FilterSize = [3, 3, GrowthRate * 4, GrowthRate/8],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1b = Layers.convolution2d(x = x_act2,
                               FilterSize = [3, 1, GrowthRate * 4, GrowthRate/8],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1c = Layers.convolution2d(x = x_act2,
                               FilterSize = [1, 3, GrowthRate * 4, GrowthRate/8],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1e = Layers.dilated_convolution2d(x = x_act2,
                                       FilterSize = [5, 5, GrowthRate * 4, GrowthRate/8],
                                       Initializer = Initializer,
                                       Rate = 2,
                                       Strides = [Strides[1], Strides[2]],
                                       Padding = 'SAME',
    ...
    x1h = Layers.separable_convolution2d(x = x_act2,
                                         FilterSize = [7, 7, GrowthRate * 4, GrowthRate/8],
                                         Initializer = Initializer,
                                         ChannelMultiplier = 2,
                                         Rate = (1,1),
                                         Strides = [Strides[1], Strides[2]],
