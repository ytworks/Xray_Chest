...
def densenet_template(x,
    ...
    root0 = tf.image.resize_images(images=root,
                                   size=[tf.constant(int(InputNode[0]), tf.int32), tf.constant(
                                       int(InputNode[1]), tf.int32)],
    ...
    x02 = transition_cell(x=x01,
                          Act=Act,
                          InputNode=[InputNode[0], InputNode[1],
                                     InputNode[2] + Channel + GrowthRate * Nums[0]],
                          Initializer=Initializer,
                          Strides=Strides,
                          Renormalization=Renormalization,
                          Regularization=Regularization,
    ...
    root1 = tf.image.resize_images(images=root,
                                   size=[tf.constant(
                                       int(InputNode[0] / 2), tf.int32), tf.constant(int(InputNode[1] / 2), tf.int32)],
                                   method=tf.image.ResizeMethod.BICUBIC,
                                   align_corners=False)
    ...
    x03 = dense_cell(x=x02_plus_root,
                     ...
                     GrowthRate=GrowthRate,
                     InputNode=[InputNode[0] / 2, InputNode[1] / 2,
                                InputNode[2] + Channel * 2 + GrowthRate * Nums[0]],
                     Initializer=Initializer,
                     Strides=Strides,
                     Renormalization=Renormalization,
                     Regularization=Regularization,
    ...
    x04 = transition_cell(x=x03,
                          Act=Act,
                          InputNode=[InputNode[0] / 2, InputNode[1] / 2, InputNode[2] +
                                     Channel * 2 + GrowthRate * (Nums[0] + Nums[1])],
                          Initializer=Initializer,
                          Strides=Strides,
                          Renormalization=Renormalization,
                          Regularization=Regularization,
    ...
    root2 = tf.image.resize_images(images=root,
                                   size=[tf.constant(int(InputNode[0] / 4), tf.int32), tf.constant(int(InputNode[1] / 4), tf.int32)],
                                   method=tf.image.ResizeMethod.BICUBIC,
                                   align_corners=False)
    ...
    x05 = dense_cell(x=x04_plus_root,
                     ...
                     Num=Nums[2],
                     GrowthRate=GrowthRate,
                     InputNode=[InputNode[0] / 4, InputNode[1] / 4, InputNode[2] +
                                Channel * 3 + GrowthRate * (Nums[0] + Nums[1])],
                     Initializer=Initializer,
                     Strides=Strides,
                     Renormalization=Renormalization,
                     Regularization=Regularization,
    ...
    x06 = transition_cell(x=x05,
                          Act=Act,
                          InputNode=[InputNode[0] / 4, InputNode[1] / 4, InputNode[2] +
                                     Channel * 3 + GrowthRate * (Nums[0] + Nums[1] + Nums[2])],
                          Initializer=Initializer,
                          Strides=Strides,
                          Renormalization=Renormalization,
                          Regularization=Regularization,
    ...
    root3 = tf.image.resize_images(images=root,
                                   size=[tf.constant(int(InputNode[0] / 8), tf.int32), tf.constant(int(InputNode[1] / 8), tf.int32)],
                                   method=tf.image.ResizeMethod.BICUBIC,
                                   align_corners=False)
    ...
    x07 = dense_cell(x=x06_plus_root,
                     ...
                     GrowthRate=GrowthRate,
                     InputNode=[InputNode[0] / 8, InputNode[1] / 8, InputNode[2] +
                                Channel * 4 + GrowthRate * (Nums[0] + Nums[1] + Nums[2])],
                     Initializer=Initializer,
                     Strides=Strides,
                     Renormalization=Renormalization,
                     Regularization=Regularization,
    ...
    x08 = transition_cell(x=x07,
                          Act=Act,
                          InputNode=[InputNode[0] / 8, InputNode[1] / 8, InputNode[2] +
                                     Channel * 4 + GrowthRate * (Nums[0] + Nums[1] + Nums[2] + Nums[3])],
                          Initializer=Initializer,
                          Strides=Strides,
                          Renormalization=Renormalization,
                          Regularization=Regularization,
    ...
    if not GroupNorm:
        x_bn1 = Layers.batch_normalization(x=x08,
                                           shape=InputNode[2] + GrowthRate * (
                                               Nums[0] + Nums[1] + Nums[2] + Nums[3]) + Channel * 4,
                                           vname=vname + '_BN01',
                                           dim=[0, 1, 2],
                                           Renormalization=Renormalization,
                                           Training=Training,
...
def densenet(x,
             ...
             vname='_DenseNet'):
    root0 = tf.image.resize_images(images=root,
                                   size=[tf.constant(int(InputNode[0]), tf.int32), tf.constant(int(InputNode[1]), tf.int32)],
                                   method=tf.image.ResizeMethod.BICUBIC,
                                   align_corners=False)
    x_plus_root = Layers.concat(xs=[x, root0], concat_type='Channel')
    ...
    x02 = transition_cell(x=x01,
                          ...
                          vname=vname + '_Transition01')
    root1 = tf.image.resize_images(images=root,
                                   size=[tf.constant(int(InputNode[0] / 2), tf.int32), tf.constant(int(InputNode[1] / 2), tf.int32)],
                                   method=tf.image.ResizeMethod.BICUBIC,
                                   align_corners=False)
    x02_plus_root = Layers.concat(xs=[x02, root1], concat_type='Channel')
    ...
    x05 = dense_cell(x=x04_plus_root,
                     ...
                     Num=48,
                     GrowthRate=GrowthRate,
                     InputNode=[InputNode[0] / 4, InputNode[1] /
                                4, InputNode[2] + 9 + GrowthRate * 18],
                     Initializer=Initializer,
                     Strides=Strides,
                     Renormalization=Renormalization,
                     Regularization=Regularization,
    ...
    x07 = dense_cell(x=x06_plus_root,
                     ...
                     Num=32,
                     GrowthRate=GrowthRate,
                     InputNode=[InputNode[0] / 8, InputNode[1] /
                                8, InputNode[2] + 12 + GrowthRate * 66],
                     Initializer=Initializer,
                     Strides=Strides,
                     Renormalization=Renormalization,
                     Regularization=Regularization,
    ...
    x08 = transition_cell(x=x07,
                          Act=Act,
                          InputNode=[InputNode[0] / 8, InputNode[1] /
                                     8, InputNode[2] + 12 + GrowthRate * 98],
                          Initializer=Initializer,
                          Strides=Strides,
                          Renormalization=Renormalization,
                          Regularization=Regularization,
