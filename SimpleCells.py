...
def densenet(x,
    ...
    if not GroupNorm:
        x_bn1 = Layers.batch_normalization(x = x08,
                                           shape = InputNode[2] + GrowthRate * 16 + 12,
                                           vname = vname + '_BN01',
                                           dim = [0, 1, 2],
                                           Renormalization = Renormalization,
                                           Training = Training,
...
def dense_cell(x,
    ...
    if SE:
        x02 = SE_module(x = x02,
                        ...
                        Act = Act,
                        vname = vname + '_SE01')
    print(x02.shape, x.shape)
    print([InputNode[0], InputNode[1], InputNode[2] + GrowthRate])
...
def conv_block(x,
    ...
    x1a = Layers.convolution2d(x = x_act2,
                               FilterSize = [3, 3, GrowthRate * 4, GrowthRate/6],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1b = Layers.convolution2d(x = x_act2,
                               FilterSize = [3, 1, GrowthRate * 4, GrowthRate/12],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1c = Layers.convolution2d(x = x_act2,
                               FilterSize = [1, 3, GrowthRate * 4, GrowthRate/12],
                               Initializer = Initializer,
                               Strides = [Strides[1], Strides[2]],
                               Padding = 'SAME',
                               ActivationFunction = 'Equal',
    ...
    x1e = Layers.dilated_convolution2d(x = x_act2,
                                       FilterSize = [5, 5, GrowthRate * 4, GrowthRate/6],
                                       Initializer = Initializer,
                                       Rate = 2,
                                       Strides = [Strides[1], Strides[2]],
                                       Padding = 'SAME',
    ...
    x1f = Layers.separable_convolution2d(x = x_act2,
                                         FilterSize = [3, 3, GrowthRate * 4, GrowthRate/12],
                                         Initializer = Initializer,
                                         ChannelMultiplier = 2,
                                         Rate = (1,1),
                                         Strides = [Strides[1], Strides[2]],
    ...
    x1g = Layers.separable_convolution2d(x = x_act2,
                                         FilterSize = [5, 5, GrowthRate * 4, GrowthRate/12],
                                         Initializer = Initializer,
                                         ChannelMultiplier = 2,
                                         Rate = (1,1),
                                         Strides = [Strides[1], Strides[2]],
    ...
    x1h = Layers.separable_convolution2d(x = x_act2,
                                         FilterSize = [7, 7, GrowthRate * 4, GrowthRate/6],
                                         Initializer = Initializer,
                                         ChannelMultiplier = 2,
                                         Rate = (1,1),
                                         Strides = [Strides[1], Strides[2]],
    ...
    x02 = Layers.concat(xs = [x1a, x1b, x1c, x1d, x1e, x1f, x1g, x1h], concat_type = 'Channel')
    if SE:
        x02 = SE_module(x = x02,
